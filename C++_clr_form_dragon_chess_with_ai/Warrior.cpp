...
list<tableRelated::Move>* Warrior::getPossibleMoves(int table, int x, int y, Piece* (&airTable)[8][12], Piece* (&earthTable)[8][12], Piece* (&undergroundTable)[8][12])
{
...
Piece* Warrior::copy()
{
	return new Warrior(this->pieceColor);
}
